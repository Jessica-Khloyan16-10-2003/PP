			...
			<form action="./OrderServlet" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: green;">Оплата картой</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="last_name">Имя владельца карты</label> <input
							type="text" placeholder="Укажите владельца карты"
							name="cardholder" class="form-control" id="last_name" required>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="last_name">Номер карты</label> <input
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Месяц истечения срока действия</label> <input type="number"
							placeholder="MM" name="expmonth" class="form-control" size="2"
							max="12" min="00" id="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="last_name">Год истечения срока действия</label> <input type="number"
				...
				<div class="row text-center">
					<div class="col-md-6 form-group">
						<label for="last_name">Укажите CVV</label> <input type="number"
