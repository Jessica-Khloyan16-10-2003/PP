...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold;">Корзина</div>
		...
		<table class="table table-hover">
			...
			<tbody
				...
				<tr style="background-color: grey; color: white;">
					<td colspan="6" style="text-align: center;">Итоговая стоимость заказа (в руб.)</td>
					<td><%=totAmount%></td>
				</tr>
				<%
				if (totAmount != 0) {
				...
				<tr style="background-color: grey; color: white;">
					...
					<td><form method="post">
							<button formaction="userHome.jsp"
								style="background-color: black; color: white;">Отменить</button>
						</form></td>
					<td colspan="2" align="center"><form method="post">
							<button style="background-color: blue; color: white;"
								formaction="payment.jsp?amount=<%=totAmount%>">Перейти к оплате</button>
						</form></td>
