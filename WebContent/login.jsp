		...
		<div class="row"
			...
			<form action="./LoginSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: green;">Форма входа</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="last_name">Имя пользователя</label> <input type="email"
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="userrole">Войти как</label> <select name="usertype"
							id="userrole" class="form-control" required>
							<option value="customer" selected>Пользователь</option>
